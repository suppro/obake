...
<div class="max-w-md mx-auto mt-16">
    <div class="bg-gray-800 rounded-lg shadow-xl p-8">
        <h2 class="text-3xl font-bold text-center mb-6 text-red-400">Вход в Obake</h2>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="remember" class="rounded bg-gray-700 border-gray-600 text-red-600">
        ...
        <p class="mt-6 text-center text-gray-400">
            Нет аккаунта? 
            <a href="{{ route('register') }}" class="text-red-400 hover:text-red-300">Зарегистрироваться</a>
        </p>
    </div>
</div>
@endsection
