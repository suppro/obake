...
<div class="max-w-md mx-auto mt-16">
    <div class="bg-gray-800 rounded-lg shadow-xl p-8">
        <h2 class="text-3xl font-bold text-center mb-6 text-purple-400">Регистрация в Obake</h2>
        ...
        <p class="mt-6 text-center text-gray-400">
            Уже есть аккаунт? 
            <a href="{{ route('login') }}" class="text-purple-400 hover:text-purple-300">Войти</a>
        </p>
    </div>
</div>
@endsection
