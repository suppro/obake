...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-8">
        <form method="POST" action="{{ route('dictionary.update', $word->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('dictionary.index') }}" class="bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded-lg transition">
                    Отмена
                </a>
            </div>
        </form>
