    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-8">
        <form method="POST" action="{{ route('admin.dictionary.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="reading" name="reading" value="{{ old('reading') }}" placeholder="例: よむ (для 読む)"
            ...
            <div class="mb-4">
                ...
                <select id="word_type" name="word_type" 
                    ...
                    <option value="Глагол" {{ old('word_type') == 'Глагол' ? 'selected' : '' }}>Глагол</option>
                    <option value="い-прилагательное" {{ old('word_type') == 'い-прилагательное' ? 'selected' : '' }}>い-прилагательное (например: 楽しい, 可愛い)</option>
                    <option value="な-прилагательное" {{ old('word_type') == 'な-прилагательное' ? 'selected' : '' }}>な-прилагательное (например: 好き, きれい)</option>
                    <option value="Существительное" {{ old('word_type') == 'Существительное' ? 'selected' : '' }}>Существительное</option>
                    <option value="Другое" {{ old('word_type') == 'Другое' ? 'selected' : '' }}>Другое</option>
                </select>
