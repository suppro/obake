...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-4xl font-bold mb-8 text-red-400">Добро пожаловать, {{ auth()->user()->name }}! 👹</h1>
    
    <div class="grid md:grid-cols-2 gap-6 mb-8">
        <a href="{{ route('stories.index') }}" class="bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition shadow-lg">
            <h2 class="text-2xl font-bold mb-2 text-red-400">📚 Рассказы</h2>
        ...
        <a href="{{ route('dictionary.index') }}" class="bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition shadow-lg">
            <h2 class="text-2xl font-bold mb-2 text-red-400">📖 Мой словарь</h2>
    ...
    <div class="bg-gray-800 rounded-lg p-6 shadow-lg">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="text-center">
                <div class="text-3xl font-bold text-red-400">{{ auth()->user()->dictionary()->count() }}</div>
            ...
            <div class="text-center">
                <div class="text-3xl font-bold text-red-400">N5</div>
